function drawMap(data) {
    ...
    context.lineWidth = 5;
    for(let i = 0; i < parsedDat.seg1Collision.elements.length; i++) {
        context.moveTo(parsedDat.seg1Collision.elements[i].line.point1.xCoord,parsedDat.seg1Collision.elements[i].line.point1.yCoord);
        context.lineTo(parsedDat.seg1Collision.elements[i].line.point2.xCoord,parsedDat.seg1Collision.elements[i].line.point2.yCoord);
        context.stroke();
    }
}